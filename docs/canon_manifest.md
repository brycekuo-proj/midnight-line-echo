...
| `3-2` | `docs/canon/season1/1-3-2(new)_260526_232201.txt` | 《在線中》 | `partial` | Online-presence horror is preserved and now includes a graphical SSD Personality Archive support interaction for inspecting stored identities. | The locked canon's dedicated online-confirmation / testimony / offline-confirmation loop is still not fully implemented; the SSD archive is a support layer, not a full replacement. |
